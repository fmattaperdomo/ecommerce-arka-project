...
public class StoreAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7934539962537688347L;
   ...
   */
  public static BinaryMessageEncoder<StoreAddress> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a StoreAddress instance decoded from the given buffer
   ...
   */
  public StoreAddress(java.lang.String id, java.lang.String street, java.lang.String city, java.lang.String state, java.lang.String country, java.lang.String zipcode) {
    this.id = id;
    this.street = street;
    this.city = city;
    this.state = state;
   ...
   */
  public static com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder newBuilder() {
    return new com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder();
  }
   ...
   * @return A new StoreAddress RecordBuilder
   */
  public static com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder newBuilder(com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder other) {
    if (other == null) {
      return new com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder();
    } else {
      return new com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder(other);
    }
  }
   ...
   * @return A new StoreAddress RecordBuilder
   */
  public static com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder newBuilder(com.fmattaperdomo.kafka.order.avro.model.StoreAddress other) {
    if (other == null) {
      return new com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder();
    } else {
      return new com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StoreAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fmattaperdomo.kafka.order.avro.model.StoreAddress other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder setStreet(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder clearStreet() {
      street = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder setState(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder setCountry(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder clearCountry() {
      country = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder setZipcode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.StoreAddress.Builder clearZipcode() {
      zipcode = null;
