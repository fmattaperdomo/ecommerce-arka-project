...
public class Category extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4195576518409321950L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Category\",\"namespace\":\"com.fmattaperdomo.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.fmattaperdomo.kafka.order.avro.model.Category.Builder newBuilder() {
    return new com.fmattaperdomo.kafka.order.avro.model.Category.Builder();
  }
   ...
   * @return A new Category RecordBuilder
   */
  public static com.fmattaperdomo.kafka.order.avro.model.Category.Builder newBuilder(com.fmattaperdomo.kafka.order.avro.model.Category.Builder other) {
    if (other == null) {
      return new com.fmattaperdomo.kafka.order.avro.model.Category.Builder();
    } else {
      return new com.fmattaperdomo.kafka.order.avro.model.Category.Builder(other);
    }
  }
   ...
   * @return A new Category RecordBuilder
   */
  public static com.fmattaperdomo.kafka.order.avro.model.Category.Builder newBuilder(com.fmattaperdomo.kafka.order.avro.model.Category other) {
    if (other == null) {
      return new com.fmattaperdomo.kafka.order.avro.model.Category.Builder();
    } else {
      return new com.fmattaperdomo.kafka.order.avro.model.Category.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Category>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fmattaperdomo.kafka.order.avro.model.Category.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fmattaperdomo.kafka.order.avro.model.Category other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.Category.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.Category.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.Category.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fmattaperdomo.kafka.order.avro.model.Category.Builder clearName() {
      name = null;
