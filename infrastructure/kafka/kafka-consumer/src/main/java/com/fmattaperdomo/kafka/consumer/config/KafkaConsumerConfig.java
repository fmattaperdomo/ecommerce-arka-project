package com.fmattaperdomo.kafka.consumer.config;

import com.fmattaperdomo.kafka.config.data.KafkaConfigData;
import com.fmattaperdomo.kafka.config.data.KafkaConsumerConfigData;
